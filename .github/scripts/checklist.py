...
def main():
    ...
    # P0: Security scan (scan for hardcoded secrets)
    ...
    # Harness eval
    eval_script = project_path / "tools" / "eval_harness.py"
    ...
    guard_test = project_path / ".github/hooks/scripts/guard.test.js"
    if guard_test.exists():
        ...
        print_warning("guard.test.js not found, skipping Guard Tests")
